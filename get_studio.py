...
print("python studio/bin/studio.py")
print("python studio/bin/studio.py -c <your_config_file.xml> -e <your_executable>")
print("python studio/bin/studio.py --rules    # to show Rules tab")
print()